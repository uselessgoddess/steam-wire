...
//!
//! Run with `--features steam-vent-proto/csgo`:
//!
//! ```sh
//! cargo run --example inventory --features steam-vent-proto/csgo -- <account> <password>
//! ```
...
use steam_vent_proto::csgo::{CMsgClientHello, CsoEconItem, GCHandshake};
