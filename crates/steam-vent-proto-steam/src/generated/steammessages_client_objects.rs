...
pub struct CCloud_PendingRemoteOperation {
    ...
    // @@protoc_insertion_point(field:CCloud_PendingRemoteOperation.os_type)
    pub os_type: ::std::option::Option<i32>,
    // @@protoc_insertion_point(field:CCloud_PendingRemoteOperation.device_type)
...
pub struct CMsgSystemDisplay {
    ...
    // @@protoc_insertion_point(field:CMsgSystemDisplay.is_vrr_output_active)
    pub is_vrr_output_active: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CMsgSystemDisplay.is_hdr_capable)
    pub is_hdr_capable: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CMsgSystemDisplay.is_hdr_output_active)
...
impl CMsgSystemDisplay {
    ...
    pub fn is_vrr_output_active(&self) -> bool {
        self.is_vrr_output_active.unwrap_or(false)
    }

    pub fn clear_is_vrr_output_active(&mut self) {
        self.is_vrr_output_active = ::std::option::Option::None;
    }

    pub fn has_is_vrr_output_active(&self) -> bool {
        self.is_vrr_output_active.is_some()
    }

    // Param is passed by value, moved
    pub fn set_is_vrr_output_active(&mut self, v: bool) {
        self.is_vrr_output_active = ::std::option::Option::Some(v);
    }
    ...
    pub fn is_hdr_output_active(&self) -> bool {
        self.is_hdr_output_active.unwrap_or(false)
    }

    pub fn clear_is_hdr_output_active(&mut self) {
        self.is_hdr_output_active = ::std::option::Option::None;
    }

    pub fn has_is_hdr_output_active(&self) -> bool {
        self.is_hdr_output_active.is_some()
    }
...
impl ::steam_vent_proto_common::protobuf::Message for CMsgSystemDisplay {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                120 => {
                    self.is_vrr_output_active = ::std::option::Option::Some(is.read_bool()?);
                },
                128 => {
                    self.is_hdr_capable = ::std::option::Option::Some(is.read_bool()?);
                },
                136 => {
                    self.is_hdr_output_active = ::std::option::Option::Some(is.read_bool()?);
                },
                146 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.is_vrr_output_active {
            my_size += 1 + 1;
        }
        if let Some(v) = self.is_hdr_capable {
            my_size += 2 + 1;
        }
        if let Some(v) = self.is_hdr_output_active {
            my_size += 2 + 1;
        }
    ...
    fn default_instance() -> &'static CMsgSystemDisplay {
        static instance: CMsgSystemDisplay = CMsgSystemDisplay {
            ...
            is_vrr_output_active: ::std::option::Option::None,
...
pub struct CMsgShortcutInfo {
    ...
    // @@protoc_insertion_point(field:CMsgShortcutInfo.remote_client_id)
    ...
    // @@protoc_insertion_point(field:CMsgShortcutInfo.remote_launch_available)
    pub remote_launch_available: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CMsgShortcutInfo.sortas)
    pub sortas: ::std::option::Option<::std::string::String>,
    // special fields
...
impl CMsgShortcutInfo {
    ...
    pub fn remote_launch_available(&self) -> bool {
        self.remote_launch_available.unwrap_or(false)
    }

    pub fn clear_remote_launch_available(&mut self) {
        self.remote_launch_available = ::std::option::Option::None;
    }

    pub fn has_remote_launch_available(&self) -> bool {
        self.remote_launch_available.is_some()
    }

    // Param is passed by value, moved
    pub fn set_remote_launch_available(&mut self, v: bool) {
        self.remote_launch_available = ::std::option::Option::Some(v);
    }

    // optional string sortas = 21;

    pub fn sortas(&self) -> &str {
        match self.sortas.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_sortas(&mut self) {
        self.sortas = ::std::option::Option::None;
    }

    pub fn has_sortas(&self) -> bool {
        self.sortas.is_some()
    }

    // Param is passed by value, moved
    pub fn set_sortas(&mut self, v: ::std::string::String) {
        self.sortas = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_sortas(&mut self) -> &mut ::std::string::String {
        if self.sortas.is_none() {
            self.sortas = ::std::option::Option::Some(::std::string::String::new());
        }
        self.sortas.as_mut().unwrap()
    }

    // Take field
    pub fn take_sortas(&mut self) -> ::std::string::String {
        self.sortas.take().unwrap_or_else(|| ::std::string::String::new())
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CMsgShortcutInfo {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                160 => {
                    self.remote_launch_available = ::std::option::Option::Some(is.read_bool()?);
                },
                170 => {
                    self.sortas = ::std::option::Option::Some(is.read_string()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.remote_launch_available {
            my_size += 2 + 1;
        }
        if let Some(v) = self.sortas.as_ref() {
    ...
    fn default_instance() -> &'static CMsgShortcutInfo {
        static instance: CMsgShortcutInfo = CMsgShortcutInfo {
            ...
            remote_launch_available: ::std::option::Option::None,
            sortas: ::std::option::Option::None,
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
// @@protoc_insertion_point(message:CMsgShortcutInfos)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CMsgShortcutInfos {
    // message fields
    // @@protoc_insertion_point(field:CMsgShortcutInfos.shorcuts)
    pub shorcuts: ::std::vec::Vec<CMsgShortcutInfo>,
    // special fields
    // @@protoc_insertion_point(special_field:CMsgShortcutInfos.special_fields)
    pub special_fields: ::steam_vent_proto_common::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CMsgShortcutInfos {
    fn default() -> &'a CMsgShortcutInfos {
        <CMsgShortcutInfos as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}

impl CMsgShortcutInfos {
    pub fn new() -> CMsgShortcutInfos {
        ::std::default::Default::default()
    }
}

impl ::steam_vent_proto_common::protobuf::Message for CMsgShortcutInfos {
    const NAME: &'static str = "CMsgShortcutInfos";
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.shorcuts.push(is.read_message()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn new() -> CMsgShortcutInfos {
        CMsgShortcutInfos::new()
    }
    ...
    fn default_instance() -> &'static CMsgShortcutInfos {
        static instance: CMsgShortcutInfos = CMsgShortcutInfos {
            shorcuts: ::std::vec::Vec::new(),
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::steam_vent_proto_common::RpcMessage for CMsgShortcutInfos {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
