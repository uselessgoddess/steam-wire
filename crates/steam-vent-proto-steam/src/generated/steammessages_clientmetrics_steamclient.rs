...
pub struct CClientMetrics_ReportClientError_Notification {
    ...
    // @@protoc_insertion_point(field:CClientMetrics_ReportClientError_Notification.tags)
...
pub struct CClientMetrics_ReportClientArgs_Notification {
    ...
    pub gr_mode: ::std::option::Option<::steam_vent_proto_common::protobuf::EnumOrUnknown<super::enums::EGRMode>>,
    // special fields
...
impl CClientMetrics_ReportClientArgs_Notification {
    ...
    // optional .EGRMode gr_mode = 10;

    pub fn gr_mode(&self) -> super::enums::EGRMode {
        match self.gr_mode {
    ...
    // Param is passed by value, moved
    pub fn set_gr_mode(&mut self, v: super::enums::EGRMode) {
        self.gr_mode = ::std::option::Option::Some(::steam_vent_proto_common::protobuf::EnumOrUnknown::new(v));
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                80 => {
                    self.gr_mode = ::std::option::Option::Some(is.read_enum_or_unknown()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
// @@protoc_insertion_point(message:CClientMetrics_ReportAccessibilitySettings_Notification)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CClientMetrics_ReportAccessibilitySettings_Notification {
    // message fields
    // @@protoc_insertion_point(field:CClientMetrics_ReportAccessibilitySettings_Notification.accessibility_desktop_ui_scale)
    pub accessibility_desktop_ui_scale: ::std::option::Option<f32>,
    // @@protoc_insertion_point(field:CClientMetrics_ReportAccessibilitySettings_Notification.accessibility_screen_reader_enabled)
    pub accessibility_screen_reader_enabled: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CClientMetrics_ReportAccessibilitySettings_Notification.accessibility_high_contrast_mode)
    pub accessibility_high_contrast_mode: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CClientMetrics_ReportAccessibilitySettings_Notification.accessibility_reduce_motion)
    pub accessibility_reduce_motion: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:CClientMetrics_ReportAccessibilitySettings_Notification.accessibility_color_filter_name)
    pub accessibility_color_filter_name: ::std::option::Option<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:CClientMetrics_ReportAccessibilitySettings_Notification.special_fields)
    pub special_fields: ::steam_vent_proto_common::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CClientMetrics_ReportAccessibilitySettings_Notification {
    fn default() -> &'a CClientMetrics_ReportAccessibilitySettings_Notification {
        <CClientMetrics_ReportAccessibilitySettings_Notification as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}

impl CClientMetrics_ReportAccessibilitySettings_Notification {
    pub fn new() -> CClientMetrics_ReportAccessibilitySettings_Notification {
        ::std::default::Default::default()
    }
...
impl ::steam_vent_proto_common::protobuf::Message for CClientMetrics_ReportAccessibilitySettings_Notification {
    const NAME: &'static str = "CClientMetrics_ReportAccessibilitySettings_Notification";
    ...
    fn new() -> CClientMetrics_ReportAccessibilitySettings_Notification {
        CClientMetrics_ReportAccessibilitySettings_Notification::new()
    }
    ...
    fn default_instance() -> &'static CClientMetrics_ReportAccessibilitySettings_Notification {
        static instance: CClientMetrics_ReportAccessibilitySettings_Notification = CClientMetrics_ReportAccessibilitySettings_Notification {
...
// @@protoc_insertion_point(message:CClientMetrics_GamePerformance_Notification)
#[derive(PartialEq,Clone,Default,Debug)]
...
impl<'a> ::std::default::Default for &'a CClientMetrics_GamePerformance_Notification {
    fn default() -> &'a CClientMetrics_GamePerformance_Notification {
        <CClientMetrics_GamePerformance_Notification as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}

impl CClientMetrics_GamePerformance_Notification {
    pub fn new() -> CClientMetrics_GamePerformance_Notification {
        ::std::default::Default::default()
    }
}

impl ::steam_vent_proto_common::protobuf::Message for CClientMetrics_GamePerformance_Notification {
    const NAME: &'static str = "CClientMetrics_GamePerformance_Notification";
    ...
    fn new() -> CClientMetrics_GamePerformance_Notification {
        CClientMetrics_GamePerformance_Notification::new()
    }
...
pub mod cclient_metrics_game_performance_notification {
    ...
    impl FrameRate {
        ...
        // Param is passed by value, moved
        pub fn set_frame_rate(&mut self, v: u32) {
        ...
        pub fn clear_session_seconds(&mut self) {
            self.session_seconds = ::std::option::Option::None;
        }

        pub fn has_session_seconds(&self) -> bool {
            self.session_seconds.is_some()
        }
...
impl ::steam_vent_proto_common::RpcMessage
for CClientMetrics_ReportAccessibilitySettings_Notification {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMessage
for CClientMetrics_GamePerformance_Notification {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMethod
for CClientMetrics_GamePerformance_Notification {
    const METHOD_NAME: &'static str = "ClientMetrics.ReportGamePerformance#1";
    type Response = ();
}
impl ::steam_vent_proto_common::RpcMethod
for CClientMetrics_IPv6Connectivity_Notification {
...
impl ::steam_vent_proto_common::RpcMethod
for CClientMetrics_ReportAccessibilitySettings_Notification {
    const METHOD_NAME: &'static str = "ClientMetrics.ReportAccessibilitySettings#1";
    type Response = ();
}
impl ::steam_vent_proto_common::RpcMethod
for CClientMetrics_ReportClientArgs_Notification {
