...
pub struct CAuthentication_RefreshToken_Enumerate_Request {
    // message fields
    // @@protoc_insertion_point(field:CAuthentication_RefreshToken_Enumerate_Request.include_revoked)
...
impl CAuthentication_RefreshToken_Enumerate_Request {
    ...
    pub fn include_revoked(&self) -> bool {
        self.include_revoked.unwrap_or(false)
    }

    pub fn clear_include_revoked(&mut self) {
        self.include_revoked = ::std::option::Option::None;
    }

    pub fn has_include_revoked(&self) -> bool {
        self.include_revoked.is_some()
    }

    // Param is passed by value, moved
    pub fn set_include_revoked(&mut self, v: bool) {
        self.include_revoked = ::std::option::Option::Some(v);
    }
}
...
impl ::steam_vent_proto_common::protobuf::Message for CAuthentication_RefreshToken_Enumerate_Request {
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.include_revoked = ::std::option::Option::Some(is.read_bool()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.include_revoked {
            my_size += 1 + 1;
        }
        my_size += ::steam_vent_proto_common::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
    ...
    fn default_instance() -> &'static CAuthentication_RefreshToken_Enumerate_Request {
        static instance: CAuthentication_RefreshToken_Enumerate_Request = CAuthentication_RefreshToken_Enumerate_Request {
            include_revoked: ::std::option::Option::None,
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub mod cauthentication_refresh_token_enumerate_response {
    ...
    pub struct RefreshTokenDescription {
        ...
        // @@protoc_insertion_point(field:CAuthentication_RefreshToken_Enumerate_Response.RefreshTokenDescription.effective_token_state)
        pub effective_token_state: ::std::option::Option<::steam_vent_proto_common::protobuf::EnumOrUnknown<super::EAuthTokenState>>,
        // special fields
    ...
    impl RefreshTokenDescription {
        ...
        // optional .EAuthTokenState effective_token_state = 13;

        pub fn effective_token_state(&self) -> super::EAuthTokenState {
            match self.effective_token_state {
                Some(e) => e.enum_value_or(super::EAuthTokenState::k_EAuthTokenState_Invalid),
                None => super::EAuthTokenState::k_EAuthTokenState_Invalid,
            }
        }

        pub fn clear_effective_token_state(&mut self) {
            self.effective_token_state = ::std::option::Option::None;
        }

        pub fn has_effective_token_state(&self) -> bool {
            self.effective_token_state.is_some()
        }

        // Param is passed by value, moved
        pub fn set_effective_token_state(&mut self, v: super::EAuthTokenState) {
            self.effective_token_state = ::std::option::Option::Some(::steam_vent_proto_common::protobuf::EnumOrUnknown::new(v));
        }
    }
    ...
    impl ::steam_vent_proto_common::protobuf::Message for RefreshTokenDescription {
        ...
        fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
            while let Some(tag) = is.read_raw_tag_or_eof()? {
                match tag {
                    ...
                    104 => {
                        self.effective_token_state = ::std::option::Option::Some(is.read_enum_or_unknown()?);
                    },
                    tag => {
                        ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                    },
        ...
        fn compute_size(&self) -> u64 {
            ...
            if let Some(v) = self.effective_token_state {
        ...
        fn default_instance() -> &'static RefreshTokenDescription {
            static instance: RefreshTokenDescription = RefreshTokenDescription {
                ...
                effective_token_state: ::std::option::Option::None,
                special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
            };
            &instance
        }
