...
// @@protoc_insertion_point(message:CGameServers_ReportServerPingReply_Notification)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct CGameServers_ReportServerPingReply_Notification {
    // message fields
    // @@protoc_insertion_point(field:CGameServers_ReportServerPingReply_Notification.server_data)
    pub server_data: ::steam_vent_proto_common::protobuf::MessageField<CMsgGameServerPingQueryData>,
    // @@protoc_insertion_point(field:CGameServers_ReportServerPingReply_Notification.ping_ms)
    pub ping_ms: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:CGameServers_ReportServerPingReply_Notification.client_sdr_location_string)
    pub client_sdr_location_string: ::std::option::Option<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:CGameServers_ReportServerPingReply_Notification.special_fields)
    pub special_fields: ::steam_vent_proto_common::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a CGameServers_ReportServerPingReply_Notification {
    fn default() -> &'a CGameServers_ReportServerPingReply_Notification {
        <CGameServers_ReportServerPingReply_Notification as ::steam_vent_proto_common::protobuf::Message>::default_instance()
    }
}

impl CGameServers_ReportServerPingReply_Notification {
    pub fn new() -> CGameServers_ReportServerPingReply_Notification {
        ::std::default::Default::default()
    }
    ...
    pub fn client_sdr_location_string(&self) -> &str {
        match self.client_sdr_location_string.as_ref() {
            Some(v) => v,
            None => "",
        }
    }

    pub fn clear_client_sdr_location_string(&mut self) {
        self.client_sdr_location_string = ::std::option::Option::None;
    }

    pub fn has_client_sdr_location_string(&self) -> bool {
        self.client_sdr_location_string.is_some()
    }

    // Param is passed by value, moved
    pub fn set_client_sdr_location_string(&mut self, v: ::std::string::String) {
        self.client_sdr_location_string = ::std::option::Option::Some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_client_sdr_location_string(&mut self) -> &mut ::std::string::String {
        if self.client_sdr_location_string.is_none() {
            self.client_sdr_location_string = ::std::option::Option::Some(::std::string::String::new());
        }
        self.client_sdr_location_string.as_mut().unwrap()
    }

    // Take field
    pub fn take_client_sdr_location_string(&mut self) -> ::std::string::String {
        self.client_sdr_location_string.take().unwrap_or_else(|| ::std::string::String::new())
    }
}

impl ::steam_vent_proto_common::protobuf::Message for CGameServers_ReportServerPingReply_Notification {
    const NAME: &'static str = "CGameServers_ReportServerPingReply_Notification";
    ...
    fn merge_from(&mut self, is: &mut ::steam_vent_proto_common::protobuf::CodedInputStream<'_>) -> ::steam_vent_proto_common::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    ::steam_vent_proto_common::protobuf::rt::read_singular_message_into_field(is, &mut self.server_data)?;
                },
                16 => {
                    self.ping_ms = ::std::option::Option::Some(is.read_uint32()?);
                },
                26 => {
                    self.client_sdr_location_string = ::std::option::Option::Some(is.read_string()?);
                },
                tag => {
                    ::steam_vent_proto_common::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.client_sdr_location_string.as_ref() {
    ...
    fn new() -> CGameServers_ReportServerPingReply_Notification {
        CGameServers_ReportServerPingReply_Notification::new()
    }
    ...
    fn default_instance() -> &'static CGameServers_ReportServerPingReply_Notification {
        static instance: CGameServers_ReportServerPingReply_Notification = CGameServers_ReportServerPingReply_Notification {
            server_data: ::steam_vent_proto_common::protobuf::MessageField::none(),
            ping_ms: ::std::option::Option::None,
            client_sdr_location_string: ::std::option::Option::None,
            special_fields: ::steam_vent_proto_common::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::steam_vent_proto_common::RpcMessage
for CGameServers_ReportServerPingReply_Notification {
    fn parse(reader: &mut dyn std::io::Read) -> ::steam_vent_proto_common::protobuf::Result<Self> {
        <Self as ::steam_vent_proto_common::protobuf::Message>::parse_from_reader(reader)
    }
    fn write(&self, writer: &mut dyn std::io::Write) -> ::steam_vent_proto_common::protobuf::Result<()> {
...
impl ::steam_vent_proto_common::RpcMethod
for CGameServers_ReportServerPingReply_Notification {
    const METHOD_NAME: &'static str = "GameServers.ReportServerPingReply#1";
    type Response = ();
}
